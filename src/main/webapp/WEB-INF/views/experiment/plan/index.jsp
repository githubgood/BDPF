...
<script src="${ctx}/resources/js/experiment/plan/plan.js"></script>
</head>
<body class="ly-bg">
	<!-- 公共头引入 -->
	...
	<article>
		<nav class="com-nav">
			<div class="w1100">
				<span class="fsize14">当前位置：
					<a class="base-color fsize14"	href="javascript:void(0);">实验管理</a>
				</span>
			</div>
		</nav>
		<section class="w1100 teachingPlan-content of">
			...
			<c:import url="/common/menu.jsp">
				...
				<c:param name="menuId"  value="plan"></c:param>
			</c:import>
				</dl>
			</div>
					...
					<div class="VMware-operate">
						...
						<div class="fr">
							<div class="VMware-search-box fl mt10">
								<input type="text" id="keywords" placeholder="请输入课程教学计划名称">
							</div>
