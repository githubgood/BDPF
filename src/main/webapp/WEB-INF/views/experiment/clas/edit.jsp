...
<form class="form-inline" id="edit-clas-form">
	...
	<div  id="message"   class="et-teachingPlan-content">
		<input type="hidden" id="id" name="id" value="${clas.id}" >
			...
			<div class="form-group">
				<label>班级名称</label> 
				<input type="text" class="form-control"	id="name"  name="name"  placeholder="1~50个字符"  value="${clas.name }">
			</div>
			<div class="form-group">
				<label>班级人数</label> 
			...
			<div class="form-group">
				<label>班级描述</label> 
				<input type="text" class="form-control"	name="description" placeholder="1~100个字符"  value="${clas.description }">
			</div>
			<div class="tac">
