...
<script src="${ctx}/resources/js/experiment/check/check.js"></script>
</head>
<body class="ly-bg">
	<!-- 公共头引入 -->
		...
		<nav class="com-nav">
			<div class="w1100">
				<span class="fsize14">当前位置： <a class="base-color fsize14"
					href="javascript:void(0);">实验管理-实验批改</a>
				</span>
			</div>
		</nav>
			...
			<div class="et-manage-nav">
				<dl>
					...
					<c:import url="/common/menu.jsp">
						...
						<c:param name="menuId" value="check"></c:param>
					</c:import>
				</dl>
			</div>
				...
				<div class="et-manage-operate">
					<div class="VMware-operate">
							...
							<div class="fl ml20 score-bar">
								<form class="form-horizontal">
									<div class="form-group mt10">
										...
										</select> <label class="fl control-label mr5 ml20 fsize14 c-2b3">班级</label>
										<select class="form-control score-select" id="classId"
											name="classId">
											<option value="">--请选择--</option>
						...
						<div id="back" class="fl ml40" style="display: none">
							<a href="javascript:void(0);" id="btn-cancel"
								class="btn search-btn">返回</a>
						</div>
					</div>
