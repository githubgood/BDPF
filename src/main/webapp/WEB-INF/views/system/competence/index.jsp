...
<meta name="renderer" content="webkit">
 <script src="${ctx}/resources/js/system/competence/competence.js"></script> 
</head>
<body>
	<!-- 公共头引入 -->
	...
	<article>
		...
		<dl>
			...
			<c:import url="/common/menu.jsp">
				...
				<c:param name="menuId"  value="competence"></c:param>
			</c:import>
			</dl>
			</div>
				...
				<div class="et-manage-operate">
					<div class="VMware-operate">
						...
						<div class="fr">
							<div class="VMware-search-box fl mt10">
								<input type="text" id="keywords" name="keywords" placeholder="请输入权限名称">
							</div>
					...
					<div class="VMware-list mt30">
						<div class="table-responsive com-table">
							...
							<tbody id="list-tbody">
								<tr>
									<td colspan="5">对不起，暂时没有您所需要的数据！</td>
								</tr>
							</tbody>
						</table>
					</div>
