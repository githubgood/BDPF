...
<meta name="renderer" content="webkit">
 <script src="${ctx}/resources/js/system/user/user.js"></script>
</head>
<body>
	<!-- 公共头引入 -->
	...
	<article>
		...
		<dl>
			...
			<c:import url="/common/menu.jsp">
				...
				<c:param name="menuId"  value="user"></c:param>
			</c:import>
			</dl>
			</div>
			<div id="content-r" class="et-manage-content">
				...
				<div>
				     <br>
				     <a class="xf-download" href="${ctx}/resources/data/教师信息.xls">点击下载数据导入模板</a>
				</div>
					...
					<div class="VMware-operate">
						...
						<div class="fr">
							<div class="VMware-search-box fl mt10">
								<input type="text" id="keywords" name="keywords" placeholder="请输入用户账号或用户名称">
							</div>
