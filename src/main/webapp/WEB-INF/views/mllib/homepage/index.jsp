...
<head>
<meta charset="UTF-8">
<title>机器学习-数据源</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta http-equiv="X-UA-Compatible" content="IE=Edge，chrome=1">
<meta name="renderer" content="webkit">
 <script src="${ctx}/resources/js/mllib/datasource/datasource.js"></script> 
 <style>
		...
		<nav class="com-nav">
			<div class="w1100">
				<span class="fsize14">当前位置：
					<a class="base-color fsize14" href="javascript:void(0);" onclick="cancel()">机器学习-数据源</a>
				</span>
			</div>
		</nav>
		<section class="w1100 teachingPlan-content of">
			...
			<dl>
				...
				<c:import url="/common/menu.jsp">
					...
					<c:param name="menuId"  value="table"></c:param>
				</c:import>
				</dl>
				</div>
