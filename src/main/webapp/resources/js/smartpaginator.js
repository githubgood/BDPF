        ...
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                function showLabels(pageIndex) {
                    ...
                    container.append($('<span/>').append($('<b/>').text('当前显示'+(pageIndex * settings.recordsperpage + 1))))
                                            /* .append($('<span/>').text('-'))
                                             .append($('<span/>').append($('<b/>').text(upper)))*/
                                             .append($('<span/>').text('/'))
                                             .append($('<span/>').append($('<b/>').text(settings.totalrecords))).append($('<span/>').text(settings.dataelement));
                }
