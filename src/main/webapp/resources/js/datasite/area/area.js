...
var area = {};
area.prePageHtml = null;
area.prePageHtml = $('#content-r').html();

var editArea = {};

var html1="";
html1+='<dl>';
html1+='<dt class="et-nav-title"><a href="javascript:void(0);">数据站点</a></dt>';
...
//		});
     ...
     */
    function add(){
    	var url = window.ctx + '/datasite/to-add';
    	var data=[
	                 {name:'id',value:id}
    	...
    	$.get(url,data,function(page){
    		$('#content-r').html(page);
    		creatTable();
    		area.validateForm('add-area-form');
    ...
    area.validateForm = function(tagid){
     ...
     */
    function enter(id){
    	var url = window.ctx + '/datasite/to-detail';
		var data=[
	                 {name:'id',value:id},
	                 {name:'type',value:"0"}
	                 ];
	...
	function toEdit(id){
		...
		var url = window.ctx + '/datasite/to-edit';
		var data=[
	                 {name:'id',value:id},
	                 {name:'type',value:"0"}
	                 ];
    	$.get(url,data, function(page){
    		...
    		editArea.validateForm('edit-area-form');
