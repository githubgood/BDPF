...
/**
 * 
 * @ClassName FeatureengineeringChildAssemblyMapper
 * @Description: 特征工程子表Mapper类
 * Copyright: Copyright (c) 2017 
 * Company:深圳市讯方技术股份有限公司
 *
 * @author jm
 * @date 2017年10月31日 上午9:10:35
 * @version V1.0
 */
public interface FeatureengineeringChildAssemblyMapper {
     ...
     * 
      ...
      * @throws
     */
    List<FeatureengineeringChildAssembly> queryByMainTableId(FeatureengineeringChildAssembly record);
    /**
     * 
