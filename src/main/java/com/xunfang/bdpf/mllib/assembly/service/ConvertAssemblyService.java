...
/**
 * @ClassName ConvertAssemblyService
 * @Description: 类型转换接口服务类
 * Copyright: Copyright (c) 2017 
 * Company:深圳市讯方技术股份有限公司
 *
 * @author jm
 * @date 2017年10月12日 上午9:52:45
 * @version V1.0
 */
public interface ConvertAssemblyService {
	/**
	 * 
	 ...
	 * 
	  ...
	  * @throws
	 */
    List<ConvertAssembly> queryConvertAssembly(String id);
