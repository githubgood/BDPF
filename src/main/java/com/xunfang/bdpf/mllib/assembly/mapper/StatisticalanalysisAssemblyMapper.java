...
/**
 * 
 * @ClassName StatisticalanalysisAssemblyMapper
 * @Description: 统计分析Mapper类
 * Copyright: Copyright (c) 2017 
 * Company:深圳市讯方技术股份有限公司
 *
 * @author jm
 * @date 2017年10月26日 上午11:09:12
 * @version V1.0
 */
public interface StatisticalanalysisAssemblyMapper {
	/**
	 * 
    ...
    /**
   	 * 
   	  ...
   	  * @throws
   	 */
    List<StatisticalanalysisAssembly> queryStatisticalanalysisAssembly(Map<String, Object> param);
