...
/**
 * 
 * @ClassName FeatureengineeringAssemblyService
 * @Description: 特征工程表Service接口类
 ...
 * @version V1.0
 */
public interface FeatureengineeringAssemblyService {
	 ...
	 * 
	  ...
	  * @throws
	 */
	List<FeatureengineeringAssembly> queryFeatureengineeringAssembly(String id);
    /**
     * 
