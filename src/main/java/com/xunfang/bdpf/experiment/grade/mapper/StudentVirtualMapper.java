...
/**
 * 
 * @ClassName StudentVirtualMapper
 * @Description: 学生与虚拟机关联mapper层接口
 ...
 * @version V1.0
 */
public interface StudentVirtualMapper {
	/**
	 * 
    ...
    /**
     * 
      * @Title: batchInsertStudentVirtual
      * @Description: 批量插入
      *  @param batchInsertStudentVirtual
      *  @return  int 返回类型
      * @throws
     */
	int batchInsertStudentVirtual(List<StudentVirtual> studentVirtualList);
     ...
     * 
      ...
      * @throws
     */
    List<StudentVirtual> selectByClassIdAndAccount(Map<String, Object> param);
}